                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php
                                        if (!isset($_GET['id'])) {
                                            $count = 1;
                                            $select_product = "SELECT * FROM products ORDER BY product_name ASC";
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"> <img src="../../images/<?php echo $row['product_cover']; ?>" width="120px" height="200px"> </td>
