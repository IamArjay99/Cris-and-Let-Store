                                ...
                                <div class="col-md-8">
                                    ...
                                    <form style="margin-left: 50px">
                                        <div class="form-group">
                                            <h4>FIRST NAME: <i><small><?php echo $user['admin_fname'] ?></small></i></h4>
                                        </div><br>
                                        <div class="form-group">
                                            <h4>LAST NAME: <i><small><?php echo $user['admin_lname'] ?></small></i></h4>
                                        </div><br>
                                        <div class="form-group">
                                            <h4>EMAIL ADDRESS: <i><small><?php echo $user['admin_email'] ?></small></i></h4>
                                        </div><br>
                                        <div class="form-group">
                                            <h4>CONTACT NUMBER: <i><small><?php echo $user['admin_number'] ?></small></i></h4>
                                        </div>
                                        <div class="form-group" align="right">
                                            <a href='update_profile.php' onclick="Javascript: return confirm('Do you want to update your profile?')" class="btn btn-success mt-4">UPDATE PROFILE</a>
                                        </div>
                                    </form>
                                    <?php
                                            }
