            ...
            <div class="app" id="app">
                ...
                <article class="content dashboard-page">
                    <div class="title-block">
                        ...
                        <p class="title-description"> Admin Log </p>
                    </div>
                    <section class="section">
                        <table class='table table-striped table-bordered table-hover'>
                            <tr class="text-center">
                                ...
                                <th> Date and Time of Used </th>
                            </tr>
                            <?php
                                $num = 0;
                                $s_admin = "SELECT * FROM admin";
                                $s_query = mysqli_query($conn, $s_admin);
                                if ($s_query) {
                                    while ($adminq = mysqli_fetch_assoc($s_query)) {
                            ?>
                            <tr class="text-center">
                                <td><?php $num = $num+1; echo $num; ?></td>
                                <td><?php echo $adminq['admin_fname']; ?></td>
                                <td><?php echo $adminq['admin_lname'];; ?></td>
                                <td><?php echo $adminq['admin_email'];; ?></td>
                                <td><?php echo $adminq['admin_number'];; ?></td>
                                <td><?php echo date('F j, Y, g:i a',strtotime($adminq['time_'])) ?></td>
                            </tr>
                            <?php
                                    }
                                }
