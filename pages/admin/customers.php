                ...
                <article class="content dashboard-page">
                    <section class="section">
                        <div class="title-block">
                            ...
                            <p class="title-description"> Customers </p>
                        </div>
                        <div class="row sameheight-container">
                            ...
                            ?>
                                <tr class="text-center">
                                    ...
                                    <td><?php echo $wor['customer_tr_no']; ?></td>
                                    <td><?php echo $wor['customer_name']; ?></td>
                                    <td><?php echo $wor['customer_email']; ?></td>
                                    <td><?php echo $wor['customer_number']; ?></td>
                            ...
                            <h5>Download all <a href="../../receipt/customer.php" class='text-primary' target='_blank'>customer here!</a></h5>
                        </div>
                    </section>
                </article>
