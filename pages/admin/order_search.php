                ...
                <article class="content dashboard-page">
                    ...
                    <section>
                        <?php
                            ...
                            $select_ = "SELECT * FROM temp_cart WHERE customer_name LIKE '%$search_query%' OR customer_tr_no LIKE '%$search_query%' OR date_ LIKE '%$search_query%'";
                            $r_select_ = mysqli_query($conn, $select_);
                            $numrows = mysqli_num_rows($r_select_);
                            if ($numrows > 0) {
                        ?>
