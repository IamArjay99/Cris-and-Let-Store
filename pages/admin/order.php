            ...
            <div class="app" id="app">
                <header class="header">
                    ...
                    <div class="header-block header-block-search">
                        <form role="search" method="GET" action="order_search.php">
                ...
                <article class="content dashboard-page">
                    <div class="title-block">
                        ...
                        <p class="title-description"> Order </p>
                    </div>
                            ...
                            if (isset($_GET['customer_tr_no'])) {
                                ...
                                if ($count_get_profile > 0) {
                                    ...
                                    while ($profile = mysqli_fetch_array($query_get_profile)) {
                                        ...
                                        <p><b>CUSTOMER NUMBER: </b><i> ". $profile['customer_tr_no'] . "</i></p><br>
                                        <p><b>FULLNAME: </b><i> ". $profile['customer_name'] . "</i></p><br>
                                        <p><b>EMAIL ADDRESS: </b><i> ". $profile['customer_email'] . "</i></p><br>
                                        <p><b>PHONE NUMBER: </b><i> ". $profile['customer_number'] . "</i></p><br>
                                        ...
                                        if ($count_get_cart > 0) {
                                            while ($rows = mysqli_fetch_array($query_get_cart)) {
                                                ...
                                                while ($row = mysqli_fetch_array($query_get_info)) {
                                                    echo "<td><img src='../../images/". $row['product_cover'] ."' width='50px' height='80px'></td>
                                                        <td><h3>". $row['product_name'] ."</h3></td>";
                                                }

                                                echo "<td><h3>". $rows['quantity'] ."</h3></td>
                                                    <td><h3> ₱". $rows['price'] ."</h3></td>
                                                </tr>";
                                            }
                                ...
                                ?>
                                    ...
                                    <form method='GET'>
                                        <div class='form-group' align='right'>
                                            <a href='payment.php?customer_tr_no=<?php echo $customer_tr_no ?>' class='btn btn-success' name='payment'>PAYMENT</a>
                    ...
                    <section>
                        <?php
                            ...
                            $select_ = "SELECT * FROM temp_cart ORDER BY customer_tr_no ASC";
                        ...
                        <table class='table table-striped table-bordered table-hover'>
                            ...
                            ?>
                            <tr class="text-center">
                                <td><?php echo $dis['customer_tr_no'];?></td>
                                ...
                                <td><?php echo '₱'.$dis['cash'];?></td>
                                <td><?php echo '₱'.$dis['change_'];?></td>
                                <td><?php echo $dis['status_of_order'];?></td>
                                <td><?php echo date('F j, Y g:iA', strtotime($dis['date_']))?></td>
                            </tr><?php } ?>
                        </table> 
                        <h5 class="text-right"><a href="../../receipt/transaction.php" class='text-primary' target='_blank'>Download</a></h5>      
                        <?php  
                            }
                        }
                        ?>
